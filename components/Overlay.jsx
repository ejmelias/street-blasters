export default function Overlay() {
    return (
        <div className="md:text-start text-center snap-y snap-proximity w-full h-full select-none ">
            ...
            <div className="h-[100vh] snap-start">
                <div className="pointer-events-none sticky top-0 inline-block max-w-[600px] p-[80px] text-gray-400 leading-6 text-sm tracking-wide">
                    <h1 className="pointer-events-none text-white text-5xl font-thin leading-none mb-1">
                        Navigators of the New Normal in Corporate Odyssey
                    </h1>
                    Welcome to the epicenter of corporate enigma, where the pulse of innovation syncs with the heartbeat of strategy. At StreetBlasters, our eclectic ensemble of strategic dreamweavers and visionary tacticians converge to rewrite the playbook of convention. We harmonize enigma and tradition to sculpt a narrative that intrigues and captivates. Take the plunge into our world of calculated bewilderment.
                </div>
            </div>
            ...
            <div className="h-[100vh]">
                <div className="pointer-events-none sticky top-0 inline-block max-w-[600px] p-[80px] text-gray-400 leading-6 text-sm tracking-wide">
                    <h1 className="pointer-events-none text-white text-5xl font-thin leading-none mb-1">
                        Synergy Spectrum Alignment
                    </h1>
                    Navigate the multifaceted spectrum of synergy with our seasoned consultants. With our intuitive Synergy Spectrum Alignment process, we pinpoint the elusive convergence points between disparate facets of your enterprise. Watch as ineffable connections emerge, propelling your business towards new dimensions of coherence, while maintaining an air of mystique.
                </div>
            </div>
            <div className="h-[100vh]">
                <div className="pointer-events-none sticky top-0 inline-block max-w-[600px] p-[80px] text-gray-400 leading-6 text-sm tracking-wide">
            ...
            <div className="h-[100vh]">
                <div class="pointer-events-none sticky top-0 inline-block max-w-[600px] p-[80px] text-gray-400 leading-6 text-sm tracking-wide">
                    <h1 className="pointer-events-none text-white text-5xl font-thin leading-none mb-1">
